...
import { LayoutDashboard, TrendingUp, BookOpen, Camera, BarChart2, Settings, Zap, Sun, Moon, Sparkles } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { path: "/tracker/ai",        label: "AI Coach",  icon: Sparkles },
