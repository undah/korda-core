...
import { Plus, Pencil, Trash2, Loader2, CheckCircle2, X, BookOpen } from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1rem' }}>
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <div
            style={{ fontSize: '0.85rem', color: '#706d66', lineHeight: 1.6, whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}
          >
