  ...
  return (
    <div style={{ marginBottom: "2rem" }}>
      <div style={{ marginBottom: "1.25rem" }}>
        <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "var(--kt-fs-2xs)", letterSpacing: "0.25em", textTransform: "uppercase", color: C.accent, opacity: 0.55, marginBottom: "0.35rem", display: "flex", gap: "0.5rem", alignItems: "center" }}>
          <span style={{ color: C.dim }}>//</span>{eyebrow}
        </p>
        <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "var(--kt-fs-lg)", fontWeight: 400, color: C.text }}>{title}</h2>
      </div>
      {children}
    </div>
  );
...
export default function TrackerSettings() {
  ...
  if (profileLoading) return (
    <div style={{ color: C.dim, fontFamily: "'DM Sans',sans-serif", fontSize: "var(--kt-fs-sm)", paddingTop: "4rem", textAlign: "center" }}>
      loading...
    </div>
  );
        ...
        <div className="kt-card">
          {userEmail && (
            <div style={{ marginBottom: "1.5rem", paddingBottom: "1.5rem", borderBottom: `1px solid ${C.border}` }}>
              ...
              <p style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "var(--kt-fs-sm)", color: C.accent }}>{userEmail}</p>
            </div>
          )}
          ...
          {bmi && (
            <div style={{ marginBottom: "1.5rem", padding: "0.75rem 1rem", background: "var(--kt-accent-bg)", border: "1px solid rgba(0,200,255,0.1)", borderRadius: "var(--kt-r-sm)", display: "flex", alignItems: "center", gap: "1rem" }}>
              ...
              <p style={{ fontSize: "var(--kt-fs-xs)", color: C.muted }}>
              ...
              {(() => {
                ...
                return (
                  <div style={{ display: "flex", gap: "2rem", flexWrap: "wrap" }}>
                    <div>
                      <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "var(--kt-fs-3xs)", textTransform: "uppercase", color: C.dim, marginBottom: "0.2rem" }}>Remaining</p>
                    ...
                    {remaining > 0 && (
                      <div>
                        <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "var(--kt-fs-3xs)", textTransform: "uppercase", color: C.dim, marginBottom: "0.2rem" }}>Estimated arrival</p>
      ...
      <Section eyebrow="Notifications" title="Daily reminder">
        <div className="kt-card">
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: notifForm.enabled ? "1.25rem" : 0 }}>
            <div>
              <p style={{ fontSize: "var(--kt-fs-md)", fontWeight: 500, color: C.text, marginBottom: "0.2rem" }}>Check-in reminder</p>
              <p style={{ fontSize: "var(--kt-fs-xs)", color: C.muted, lineHeight: 1.5 }}>Get a daily notification to log your weight</p>
            </div>
            {/* Toggle */}
            <button
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <div className="kt-card">
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
              <div>
                <p style={{ fontSize: "var(--kt-fs-md)", fontWeight: 500, color: C.text, marginBottom: "0.3rem" }}>Export data as CSV</p>
                <p style={{ fontSize: "var(--kt-fs-sm)", color: C.muted, lineHeight: 1.6 }}>
                  Download all your check-ins and calorie logs as a CSV file.
                  {checkins.length > 0 && <span style={{ color: C.accent, fontFamily: "'IBM Plex Mono',monospace", fontSize: "var(--kt-fs-xs)" }}> {checkins.length} check-ins · {calories.length} calorie logs</span>}
                </p>
              </div>
          ...
          <div className="kt-card" style={{ borderTop: "1px solid rgba(239,68,68,0.3)" }}>
            <p style={{ fontSize: "var(--kt-fs-md)", fontWeight: 500, color: C.red, marginBottom: "0.3rem" }}>Delete all data</p>
            <p style={{ fontSize: "var(--kt-fs-sm)", color: C.muted, lineHeight: 1.6, marginBottom: "1.5rem" }}>
            ...
            {!showDeleteConfirm ? (
              ...
              <div>
                <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: "var(--kt-fs-xs)", color: C.red, opacity: 0.8, marginBottom: "0.75rem" }}>
