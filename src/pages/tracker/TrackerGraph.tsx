  ...
  if (sorted.length < 2) return (
    <div>
      ...
      <div className="kt-card" style={{ textAlign: "center", padding: "4rem 1.5rem" }}>
        ...
        <p style={{ color: "var(--kt-muted)", fontSize: "var(--kt-fs-md)", marginBottom: "2rem" }}>Log at least 2 check-ins to see your trend.</p>
  ...
  return (
    <div>
          ...
          <div style={{ display: "flex", background: "var(--kt-surface2)", border: "1px solid var(--kt-border)", borderRadius: "var(--kt-r-sm)", overflow: "hidden", flexShrink: 0 }}>
            {RANGES.map(r => (
              <button
                key={r}
                onClick={() => setRange(r)}
                style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "var(--kt-fs-2xs)", letterSpacing: "0.06em", padding: "0.4rem 0.75rem", background: range === r ? "var(--kt-accent)" : "transparent", color: range === r ? "var(--kt-bg)" : "var(--kt-muted)", border: "none", cursor: "pointer", fontWeight: range === r ? 600 : 400, transition: "all 0.15s" }}
              >
                {r}
              </button>
            ))}
      ...
      <div className="kt-card" style={{ marginBottom: "1.25rem" }}>
        ...
        />
        {photos.length > 0 && (
          <p style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "var(--kt-fs-3xs)", letterSpacing: "0.12em", color: "var(--kt-dim)", marginTop: "0.75rem" }}>
      ...
      <div className="kt-grid-2" style={{ marginBottom: "2rem" }}>
        <div className="kt-card">
          ...
          <p className="kt-num-lg" style={{ color: change != null ? (change <= 0 ? "var(--kt-green)" : "var(--kt-red)") : "var(--kt-text)" }}>
        ...
        <div className="kt-card">
          ...
          <p className="kt-num-lg" style={{ color: "var(--kt-text)" }}>
      ...
      <div style={{ marginBottom: "0.5rem" }}>
        <p style={{ fontFamily: "'IBM Plex Mono',monospace", fontSize: "var(--kt-fs-2xs)", letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--kt-accent)", opacity: 0.7 }}>
          Body composition
        </p>
