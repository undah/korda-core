...
import { Plus, Search, Filter, Calendar, Tag, ArrowUpRight, ArrowDownRight } from "lucide-react";
    ...
    <MainLayout>
      <div className="mb-8 flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Document your trades and learn from them</p>
        </div>
        <Button variant="glow">
